...
// This function handles the addition of a new blog post to a GitHub repository.const fetch = require('node-fetch');
const { Buffer } = require('buffer');
...
`;
  ...
  try {
    ...
    return {
      statusCode: 500,
      body: JSON.stringify({ error: 'Error submitting blog post - Contact the genius behind this!', details: err.message }),
    };
  }
};
